...
if (typeof self.readStream == "undefined" || typeof self.readWebStream == "undefined") {
    ...
    if (api_script === null) {
        alert("Also import script 'f-ReadStream'. \n This script depends on it.");
        return;
    }
...
//var msg="w: i: "+LL.getCurrentDesktop().getWidth()+", c: "+event_c.getWidth()+"\nh: i: "+LL.getCurrentDesktop().getHeight()+", c: "+event_c.getHeight();
...
var pw=event_c.getWidth();
var ph=event_c.getHeight();
...
var base_i = make_panel(event_c, "HS_time");
...
//create the base panel
var base_i = make_panel(event_c, "HS_alarm");
base_i.getProperties().edit().setBoolean("i.onGrid",false).commit();
base_i.setSize(w,h);
base_i.setPosition(x,y);
...
//create the base panel
var base_i = make_panel(event_c, "HS_weather");
base_i.getProperties().edit().setBoolean("i.onGrid",false).commit();
base_i.setSize(w,h);
base_i.setPosition(x,y);
set_panel_defaults(base_i,4,1)
var base_c = base_i.getContainer();
//draw_circle(base_i);
//not working -base_i.getProperties().edit().setEventHandler("i.tap", EventHandler.OPEN_FOLDER,event_c.getItemByName("weather_fol").getContainer().getId()).commit();
...
ed.setEventHandler("i.tap", EventHandler.OPEN_FOLDER,event_c.getItemByName("weather_fol").getContainer().getId());
...
//create the base panel
var base_i = make_panel(event_c, "HS_date");
base_i.getProperties().edit().setBoolean("i.onGrid",false).commit();
base_i.setSize(w,h);
base_i.setPosition(x,y);
